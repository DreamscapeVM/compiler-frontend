#ifndef __INCLUDE_LINKER_TYPE_CONVERT_VARIANTTYPE_TO_SIZE_H
#define __INCLUDE_LINKER_TYPE_CONVERT_VARIANTTYPE_TO_SIZE_H
...
#endif // __INCLUDE_LINKER_TYPE_CONVERT_VARIANTTYPE_TO_SIZE_H